...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/qingdi1/sub2api-qingyun-public:latest
...
SUB2API_IMAGE=ghcr.io/qingdi1/sub2api-qingyun-public:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
