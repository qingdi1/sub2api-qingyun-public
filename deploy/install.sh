...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/qingdi1/sub2api-qingyun-public/qingyun-chat/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="qingdi1/sub2api-qingyun-public"
...
Documentation=https://github.com/qingdi1/sub2api-qingyun-public
