...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/PAYMENT_CN.md"
    : "https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/PAYMENT.md#supported-payment-methods",
);
...
async function loadSettings() {
  ...
  try {
    ...
    selectedUiStyle.value = applyUiStyle(settings.ui_style);
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      ui_style: selectedUiStyle.value,
    ...
    selectedUiStyle.value = applyUiStyle(updated.ui_style);
