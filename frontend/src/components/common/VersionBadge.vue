...
const GITHUB_REPO = 'qingdi1/sub2api'
// GHCR image published by Qingyun CI (tags carry no "v" prefix, e.g. ghcr.io/qingdi1/sub2api:0.1.158)
const DOCKER_IMAGE = 'ghcr.io/qingdi1/sub2api'
