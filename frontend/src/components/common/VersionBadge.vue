...
const GITHUB_REPO = 'qingdi1/sub2api-qingyun-public'
// GHCR image published by Qingyun CI (tags carry no "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/qingdi1/sub2api-qingyun-public'
