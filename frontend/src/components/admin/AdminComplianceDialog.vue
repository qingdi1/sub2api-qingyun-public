...
const documentUrl = computed(() => {
  if (getLocale() === 'zh') {
    return complianceStore.status?.document_url_zh || 'https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/legal/admin-compliance.zh.md'
  }
  return complianceStore.status?.document_url_en || 'https://github.com/qingdi1/sub2api-qingyun-public/blob/qingyun-chat/docs/legal/admin-compliance.en.md'
})
